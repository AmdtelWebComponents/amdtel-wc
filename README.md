# amdtel-wc
[![Published on npm](https://img.shields.io/npm/v/@amdtel/amdtel-wc.svg?style=flat)](https://www.npmjs.com/package/@amdtel/amdtel-wc)
[![Build Status](https://travis-ci.org/AmdtelWebComponents/amdtel-wc.svg?branch=master)](https://travis-ci.org/AmdtelWebComponents/amdtel-wc)
[![Dependency Status](https://img.shields.io/david/AmdtelWebComponents/amdtel-wc.svg?style=flat)](https://david-dm.org/AmdtelWebComponents/amdtel-wc)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/AmdtelWebComponents)
Welcome to the amdtel-wc project!
Web component factory for Amdtel Web Development
## Quick-start
...
```bash
$ git clone git@github.com:AmdtelWebComponents/amdtel-wc.git
$ cd amdtel-wc
$ yarn install
$ yarn start
```
...
- `$ yarn test`
    -  Run tests on ALL amdtel-wc.
- `$ yarn run build`
    -  Run build on ALL amdtel-wc.
- `$ yarn run storybook`
    - Run storybook
- `$ yarn run build-storybook`
    - Build storybook for deployment
- `$ lerna publish`
    - Publish ALL amdtel-wc' elements to npmjs.com
...
To test all amdtel-wc, run `yarn test` from the root of the repo. If you only want to test the web component you're working on:
...
Then open the URL that will be printed in the terminal. It looks something like this: `http://localhost:8081/components/@@amdtel/amdtel-wc/generated-index.html?cli_browser_id=0`.

## Storybook

We've added [Storybook](https://storybook.js.org/) to amdtel-wc as a way to preview our web components as they are being developed. We'll also use Storybook to export a static site that will be the demo site for amdtel-wc.
...
```js
"../../whatwg-fetch/fetch.js": path.join( // this is the third-party dependency in the amdtel-wc
  __dirname,
